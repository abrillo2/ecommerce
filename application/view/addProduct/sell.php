<form class="form-horizontal" action="<?php echo $add_product_url?>uploadRequest" method="post">
<fieldset>

<!-- Form Name -->
<legend style="text-align:'center';">
    <h3 style="text-align: center;">Post Buyer's Request</h3>
</legend>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name">What Are You looking for?</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="product_name">Your Budget($)</label>  
  <div class="col-md-4">
