		  	  ...
		  	  <form action='<?php echo $home_url.'registerUser'?>' method="post"> 
				 <div class="register-top-grid">
					...
					<div class="mation">
						...
						<span>National Id<label>*</label></span>
						<input type="text" name="national_Id" pattern="[a-z,A-Z,0-9,' ']{1,15}" required> 
					 
						 <span>Email Address<label>*</label></span>
						 <input type="email" name="user_email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required> 

						 <span>Phone#<label>*</label></span>
						 <input type="tel" name="phone_number" pattern="[0-9]{6,15}" required> 

						 <span>Street<label></label></span>
						 <input type="text" name="street_number"> 

						 <span>Station<label></label></span>
						...
						<?php foreach($city as $i)
						 ...
						 <br>
						<br>
						 <span>district<label>*</label></span>
						...
						<br>
						<br>
						 <span>division<label>*</label></span>
						 ...
						 <br>
						 <br>
						 <span>Postal Code<label>*</label></span>
				     ...
				     <div class="  register-bottom-grid">
							...
							<div class="mation">
								<span>Password<label>*      (6 chracters minimum, atleast 1 small and capital letter and a number)</label></span>
								<input type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}" required >
